...

{
    ...
    label4:
        "Start";
        cout << "Alpha Version 0.0.16 Creative Common License 2017 \n";
        ...
        switch (choice)
        {
            ...
            case 5:
                ...
                break;
                case 6:
                cout <<"Welcome to the end of the program. I am sorry to say i am droppping this \n";
                cout << "and moving on to a new project. Thank you for supporting me in this endevour.";
                cout << "It has been a blast. Be on the watch for something new. Still going to do a \n";
                cout << "text adventure. But something with more direction and of my own brain. Again thank you.";
                cout << "You will be taken back to the main menu soon.";
                sleep(20);
                if (system("CLS"))
                    system("clear");
                    goto label4;
